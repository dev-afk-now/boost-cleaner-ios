...
//                return "Touch ID/Face ID"
    ...
    var biometricType: BiometricType {
        ...
        guard myContext.canEvaluatePolicy(.deviceOwnerAuthenticationWithBiometrics, error: &error) else {
            return .none
        }
        ...
        return  myContext.canEvaluatePolicy(.deviceOwnerAuthenticationWithBiometrics, error: nil) ? .touchID : .none
    }
    ...
    init(policy: LAPolicy = .deviceOwnerAuthentication,
         ...
         localizedFallbackTitle: String = "Enter App Password".localized) {
        self.policy = policy
