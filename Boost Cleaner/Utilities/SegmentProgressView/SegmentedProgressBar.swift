...
public final class SegmentedProgressBar: UIView {
    ...
    private weak var delegate: SegmentedProgressBarDelegate?
    private weak var dataSource: SegmentedProgressBarDataSource?
    ...
    public init(frame: CGRect, delegate: SegmentedProgressBarDelegate, dataSource: SegmentedProgressBarDataSource) {
