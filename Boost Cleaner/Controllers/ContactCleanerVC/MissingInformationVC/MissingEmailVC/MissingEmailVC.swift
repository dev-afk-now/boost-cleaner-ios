...
class MissingEmailVC: UIViewController ,CNContactViewControllerDelegate{
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.title = "Missing Email".localized
    ...
    func confirmedDelete() {
        ...
        for i in 0..<selectedRows.reversed().count {
            ...
            let contact = ContactArray[selectedRows[i].row]
    ...
    func FetchNumber(){
        ...
        self.ContactArray = results
        self.ContactArray = ContactArray.sorted { (a, b) -> Bool in
            //            if a.givenName.isEmpty {
            //                return false
            //            } else if b.givenName.isEmpty {
            //                return true
            //            } else {
            //                return a.givenName.localizedCaseInsensitiveCompare(b.givenName) == .orderedAscending
            //            }
    ...
    func getAllIndexPaths() -> [IndexPath] {
        ...
        for j in 0..<contactsTableView.numberOfRows(inSection: 0) {
...
extension MissingEmailVC : UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        var dataArry = self.ContactArray[indexPath.row]
        ...
        if(dataArry.givenName == "" &&  dataArry.familyName == ""){
            // cell.namelbl.text = "Unnamed contact"
            if(dataArry.phoneNumbers.first?.value.stringValue == nil){
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        DispatchQueue.main.async {
            ...
            var contact = self.ContactArray[indexPath.row]
...
extension MissingEmailVC: AlterDeleteDelegate {
