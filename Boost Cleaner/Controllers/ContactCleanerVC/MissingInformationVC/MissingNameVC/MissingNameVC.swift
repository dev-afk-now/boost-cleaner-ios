...
class MissingNameVC: UIViewController ,CNContactViewControllerDelegate{
...
extension MissingNameVC : UITableViewDelegate, UITableViewDataSource {
...
extension MissingNameVC: AlterDeleteDelegate {
