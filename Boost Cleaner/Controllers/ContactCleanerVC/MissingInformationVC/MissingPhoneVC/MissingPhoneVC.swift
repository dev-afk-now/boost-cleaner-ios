...
class MissingPhoneVC: UIViewController ,CNContactViewControllerDelegate{
...
extension MissingPhoneVC : UITableViewDelegate, UITableViewDataSource {
...
extension MissingPhoneVC: AlterDeleteDelegate {
